...
class Gua(Document):
    meta = {'collection': CONFIG_JSON.get("mongo_databses").get("aliyun")[0].get("gua").get("collection_name")[0]}
...
class GuaRModel(Document):
    meta = {'collection': CONFIG_JSON.get("mongo_databses").get("aliyun")[0].get("gua").get("collection_name")[1]}
